...
import { FirstAdminModule } from 'app/admin/admin.module';
import {
    BlogComponent,
    BlogDetailComponent,
    BlogUpdateComponent,
...
@NgModule({
    imports: [FirstSharedModule, FirstAdminModule, RouterModule.forChild(ENTITY_STATES)],

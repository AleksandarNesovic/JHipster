...
describe('Tag e2e test', () => {
    ...
    it('should load Tags', async () => {
        ...
        expect(await tagComponentsPage.getTitle()).toMatch(/firstApp.tag.home.title/);
    });

    it('should load create Tag page', async () => {
        await tagComponentsPage.clickOnCreateButton();
        tagUpdatePage = new TagUpdatePage();
        expect(await tagUpdatePage.getPageTitle()).toMatch(/firstApp.tag.home.createOrEditLabel/);
    ...
    it('should delete last Tag', async () => {
        ...
        expect(await tagDeleteDialog.getDialogTitle()).toMatch(/firstApp.tag.delete.question/);
